...
-   A CRS [contains both a datum and a projection]{style="color:#8A2BE2"}.

-   Common CRS include **WGS84 (GPS coordinates)** and **UTM (Universal Transverse Mercator)**.

-   Frequently encountered datums:

    -   [WGS84]{style="color:blue"} – World Geodetic System (created in) 1984. The origin is the center of the earth.
    -   [NAD27 & NAD83]{style="color:blue"} – North American Datum 1927 and 1983, respectively. The origin for NAD 27 is Meades Ranch in Kansas.
    -   [ED50]{style="color:#8A2BE2"} – European Datum 1950
